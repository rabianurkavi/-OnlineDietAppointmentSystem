...
namespace DataAccess.Migrations
{
    ...
    [Migration("20240522162552_mig_about_update_property")]
    partial class mig_about_update_property
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Concrete.Comment", b =>
                {
                    ...
                    b.Property<float>("ConsultantScore")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Entities.Concrete.SiteContact", b =>
                {
                    b.Property<int>("SiteContactID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SiteContactID"), 1L, 1);

                    b.Property<string>("SiteContactAdress")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SiteContactMail")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Entities.Concrete.Message", b =>
                {
                    b.HasOne("Entities.Concrete.Client", "ReceiverUser")
                        .WithMany("ReceiverMessage")
                        .HasForeignKey("ReceiverID")
                        .IsRequired();

                    b.HasOne("Entities.Concrete.Client", "SenderUser")
